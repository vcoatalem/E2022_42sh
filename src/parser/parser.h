...
enum rule_id //MORE RULES TO BE ADDED
{
    ...
    RULE_ELEMENT_TILDE,                 //36
    RULE_ELEMENT_LIST,                  //37
    RULE_ELEMENT_ANY,                   //38
    RULE_ELEMENT_ANY_LIST,              //39
    RULE_ARG_LIST,                      //40
    RULE_IF,                            //41
    RULE_THEN,                          //42
    RULE_ELSE_CONCAT,                   //43
    ...
    RULE_UNTIL,                         //45
    RULE_DO_GROUP,                      //46
    RULE_FUNCDEC_BODY,                  //47
    RULE_FUNCDEC,                       //48
    RULE_VARDEC,                        //49
    RULE_CASE,                          //50
    RULE_CASE_LINEBREAK,                //51
    RULE_CASE_CLAUSE,                   //52
    RULE_CASE_DELIM,                    //53
    RULE_CASE_CLAUSE_CONCAT,            //54
    RULE_CASE_ITEM,                     //55
    RULE_CASE_ITEM_CONCAT,              //56
    RULE_FOR,                           //57
    RULE_FOR_ELEMENT_LIST,              //58
    RULE_FOR_LINEBREAK,                 //59
    RULE_FOR_DELIM,                     //60
    RULE_FOR_CLAUSE,                    //61
};
